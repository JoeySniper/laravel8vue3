                ...
                <div class="col-xl-12">
						<div class="card">
							...
							<div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" v-model="FormProduct.name" id="product-name" placeholder="ປ້ອນຊື່ສິນຄ້າ...">
                                                </div>

                                                <div class="form-group">
                                                    <label for="product-count">ຈຳນວນ</label>
                                                    <cleave :options="options" class="form-control" v-model="FormProduct.amount" id="product-count" placeholder="ຈຳນວນສິນຄ້າ..."/>

                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="product-buy">ລາຄາຊື້</label>
                                                    <cleave :options="options" class="form-control" v-model="FormProduct.price_buy" id="product-buy" placeholder="ລາຄາຊື້..."/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="product-sell">ລາຄາຂາຍ</label>
                                                    <cleave :options="options" class="form-control" v-model="FormProduct.price_sell" id="product-sell" placeholder="ລາຄາຂາຍ..."/>
                                                </div>
                                            </div>
                                ...
                                <!-- <button class="btn btn-info btn-icon" @click="showalert()"><i class="fa fa-edit"></i></button> -->
...
export default {
    ...
    methods: {
        ...
        del_product(id){
            ...
            confirmButtonText: 'ຢືນຢັນການລຶບ',
