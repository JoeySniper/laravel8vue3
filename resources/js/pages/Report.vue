								...
								<div class="row">
									...
									<div class="col-6">
										<div class="mt-0 text-center">
											...
											<h2 class="text-white mb-0">{{formatPrice(sum_income)}}</h2>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="row">
									...
									<div class="col-6">
										<div class="mt-0 text-center">
											...
											<h2 class="text-white mb-0">{{formatPrice(sum_expense)}}</h2>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="row">
									...
									<div class="col-6">
										<div class="mt-0 text-center">
											...
											<h2 class="text-white mb-0">{{formatPrice(sum_profit)}}</h2>
										</div>
									</div>
								</div>
							</div>
